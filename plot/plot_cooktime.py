...
abr = {'Japan':'JPN', 'Thai':'THA', 'Italy':'ITA', 'China':'CHN', 'France':'FRC', 'Mexico':'MEX', 'Greece':'GRC','India':'IND','Korea':'KOR','US':'USA'}

def get_cooking_time_graph(countries):
    '''
    ...
    for i in range(len(countries)):
        ...
        prep_time_dict[countries[i]] = sum_time/len(contents)

    working_hrs = {'Japan':1742, 'Thai':1200, 'Italy':1730, 'China':2392, 'France':1472, 'Mexico':2250, 'Greece':2035,'India':1974,'Korea':2070,'US':2428}
